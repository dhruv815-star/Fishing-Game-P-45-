...
function setup() 
{
  ...
  sophia.addAnimation("sophie",sophiaAnimation);
  sophia.scale = 1.6;
...
function draw() 
{
  ...
  if(gameState===1)
  {
      ...
      strokeWeight (5);
      line (hook.x,hook.y-20,sophia.x+170+rnd,sophia.y-120)-rnd;
      ...
      //connector.
      image(connectorImg,sophia.x+150, sophia.y-130,30,20);
